document.addEventListener("DOMContentLoaded", function () {
  ...
  if (countdownElement) {
    ...
    // --- Counter Logic Variables (Scoped locally) ---
    ...
    /**
     * Calculates and updates the time difference since a start date.
     */
    ...
    // --- Index.html Main Countdown Logic (from original file) ---
    ...
    function updateCountdown() {
      ...
      if (now_time > windowEndDate) {
        countdownElement.innerHTML = `Dead, Cured, and Doing Yoga<br><span style="font-size: 0.5em;">There's games afoot</span>`;
      ...
      // Update the new counters inside the main countdown update loop
      updateAllCounters();
    }
    ...
    // Launch skull and a one-time confetti burst on page load for index.html
    launchSkullEffect();
  ...
  // Cured Poll and Latvia Edgar Poll logic were already correctly isolated by
  // checking for their section IDs. We will maintain that original pattern.
